...
from apps.admin.models.customer import Customer


class CustomerAdmin(SwiftAdmin):
    group_schema = "Customer"
    page_schema = PageSchema(label='客户管理', page_title='客户管理', icon='fa fa-bolt', sort=99)
    model = Customer
    pk_name = 'customer_id'
    list_per_page = 10
